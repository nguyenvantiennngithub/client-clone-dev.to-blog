...
const updateInfoUser = (payload) => axios.post(`${URL}/auth/update-info`, payload, {headers: {Authorization: localStorage.getItem('token')}});
const changePassword = (payload) => axios.post(`${URL}/auth/change-password`, payload, {headers: {Authorization: localStorage.getItem('token')}});
